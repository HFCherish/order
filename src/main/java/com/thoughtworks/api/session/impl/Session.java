package com.thoughtworks.api.session.impl;

import com.thoughtworks.api.session.SessionStorage;

import java.util.Map;
import java.util.stream.Stream;

public class Session implements com.thoughtworks.api.session.Session {
